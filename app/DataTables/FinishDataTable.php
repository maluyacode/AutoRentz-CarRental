...
class FinishDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                return '<form action="' . route('deleteBooking', $row->id) . '" method="POST" style="display: inline-block; width: 100px; margin:5px;">
