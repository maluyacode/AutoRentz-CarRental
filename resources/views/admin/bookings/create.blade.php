                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="start_date" name="start_date" class="form-control"
                                                min="<?php echo date('Y-m-d'); ?>" value="{{ old('start_date') }}">
                                            @error('start_date')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="end_date" name="end_date" class="form-control"
                                                min="<?php echo date('Y-m-d'); ?>" value="{{ old('end_date') }}">
                                            @error('end_date')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check form-check-inline" style="margin-top:30px ">
                                            <input class="form-check-input" type="radio" name="typeget" id="pickup-radio"
                                                value="pickup" {{ old('typeget') == 'pickup' ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                            ...
                                            <select class="form-control" id="pickup-location" name="pick_id">
                                                ...
                                                @foreach ($allLocation as $locations)
                                                    <option value="{{ $locations->id }}"
                                                        {{ old('pick_id') == $locations->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" id="return-location"
                                                ...
                                                @foreach ($allLocation as $locations)
                                                    <option value=" {{ $locations->id }}"
                                                        {{ old('return_id') == $locations->id ? 'selected' : '' }}>
                                                        {{ $locations->street . ', ' . $locations->baranggay . ', ' . $locations->city }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select type="text" class="form-control" id="drive-type" name="drivetype">
                                            <option selected>Select</option>
                                            <option value="1" {{ old('drivetype') == '1' ? 'selected' : '' }}>With Driver
                                            </option>
                                            <option value="0" {{ old('drivetype') == '0' ? 'selected' : '' }}>Self Drive
                                            </option>
                                        </select>
                                        @error('drivetype')
                                            <small>{{ $message }}</small>
